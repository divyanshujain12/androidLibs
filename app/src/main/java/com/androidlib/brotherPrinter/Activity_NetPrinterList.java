...
public class Activity_NetPrinterList extends ListActivity {
    ...
    String printerPT750W, printerQL720;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        printerPT750W = PrinterInfo.Model.PT_P750W.name().replaceAll("_", "-");
        printerQL720 = PrinterInfo.Model.QL_720NW.name().replaceAll("_", "-");
        printers = new String[]{printerPT750W, printerQL720};
    ...
    protected void onListItemClick(ListView listView, View view, int position,
        ...
        if (!item.equalsIgnoreCase(getString(R.string.no_network_device))) {
            ...
            final Intent settings = new Intent(this, BaseActivity.class);
            settings.putExtra(BasePrint.IP_ADDRESS, mNetPrinter[position].ipAddress);
            settings.putExtra(BasePrint.MAC_ADDRESS, mNetPrinter[position].macAddress);
            settings.putExtra(BasePrint.MODEL_NUMBER, mNetPrinter[position].modelName);
    ...
    private boolean netPrinterList(int times) {
        ...
        try {
            ...
            mNetPrinter = myPrinter.getNetPrinters(printers);
