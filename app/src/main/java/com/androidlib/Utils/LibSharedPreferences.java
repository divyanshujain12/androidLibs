...
public class LibSharedPreferences {
    ...
    public static LibSharedPreferences instance;
    public static final String APP_PREFERENCE = "OmadreLibPreference";
    private LibSharedPreferences() {
    }

    public static LibSharedPreferences getInstance() {
        if (instance == null) {
